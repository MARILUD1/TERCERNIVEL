...
namespace RegistroAporte
{
    public class Socio // Plublic: modificador de acseso público
    {
        ...
        { 
            IdSocio =IdSocio;//identificador del socio
            Nombre = nombre;
            Apellido = apellido;
    ...
    public class Asociacion//Agrega socios y gestiona aportes
    {
        ...
        {
            var socio  =  socios.Find(e => e.IdSocio == idSocio);
       ...
       class Program
       {
          ...
          static void Main(string[] args) // se ejecutan las intrucciones 
          {
            ...
            // Agregar socios
            asociacion.AgregarSocio(socio1);
            ...
            asociacion.MostrarSocios();
            Console.WriteLine();
            Console.Write("EL EXITO NO SE MIDE POR LO QUE LOGRAS, SINO POR LOS OBSTACULOS QUE SUPERAS");
            Console.WriteLine();
